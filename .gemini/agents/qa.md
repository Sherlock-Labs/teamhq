...
3. Review what Alice and Jonah built (check their filesChanged in data/pipeline-log/{project-slug}.json)
...
- [ ] Have I documented all findings in data/pipeline-log/{project-slug}.json?
